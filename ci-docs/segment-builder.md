...
description: Vytvářejte segmenty zákazníků a seskupujte je na základě různých atributů pomocí nástroje pro tvorbu segmentů nebo rychlých segmentů.
ms.date: 03/25/2022
